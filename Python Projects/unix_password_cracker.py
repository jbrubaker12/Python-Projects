...
def argument_parser():
    ...
    parser.add_argument("--repo", nargs="?", default="./plaintext_repo.txt", help="Location of the plain-text password file. Default: ./plaintext_repo.txt")
    parser.add_argument("--pass_file", nargs="?", default="./user_passwords.txt", help="Location of the user:password file from the target system. Default: ./user_passwords.txt")
